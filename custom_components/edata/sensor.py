...
ENERGY_SENSORS_DESC = [
    (
        ...
        [
            "last_datetime",
            "last_day_delta_h",
            "last_day_consumption_by_tariff",
        ],
    ),
    (
    ...
    (
        ...
        [
            "last_month_delta_h",
            "last_month_consumption_by_tariff",
        ],
    ),
    (
